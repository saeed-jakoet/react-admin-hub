    ...
    if (selectedJobType && selectedClient) {
      ...
      if (client) {
        ...
        const jobTypeRoutes = {
          ...
          "Floating Civils (ADW)": "floating_civils",
        ...
        const route = jobTypeRoutes[selectedJobType] || "drop_cable";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md">
            <div className="p-6">
              ...
              <div>
                <p className="text-gray-600 dark:text-slate-400 text-sm font-medium mb-1">Revenue (MTD)</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">R284.5K</p>
                <p className="text-green-600 dark:text-green-400 text-sm font-medium">+12% from last month</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md">
            <div className="p-6">
              ...
              <div>
                <p className="text-gray-600 dark:text-slate-400 text-sm font-medium mb-1">Active Jobs</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">12</p>
                <p className="text-gray-600 dark:text-slate-400 text-sm">8 in progress</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md">
            <div className="p-6">
              ...
              <div>
                <p className="text-gray-600 dark:text-slate-400 text-sm font-medium mb-1">Team Utilization</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">87%</p>
                <p className="text-gray-600 dark:text-slate-400 text-sm">13/15 technicians</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md">
            <div className="p-6">
              ...
              <div>
                <p className="text-gray-600 dark:text-slate-400 text-sm font-medium mb-1">Critical Stock</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">3</p>
                <p className="text-orange-600 dark:text-orange-400 text-sm font-medium">Items need reorder</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm">
              <div className="p-6 border-b border-gray-200 dark:border-slate-700">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Active Operations</h3>
                    <p className="text-gray-600 dark:text-slate-400">Real-time field activity</p>
                  </div>
              ...
              <div className="p-6 space-y-4">
                {[
                  ...
                  <div key={op.id} className="p-5 rounded-lg bg-gray-50 dark:bg-slate-700/50 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-200 dark:border-slate-600">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <h4 className="font-bold text-gray-900 dark:text-white mb-1 text-lg">{op.client}</h4>
                      ...
                      <div className="text-right ml-6">
                        <div className="text-2xl font-bold text-gray-900 dark:text-white">{op.progress}%</div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 shadow-sm">
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-red-900 dark:text-red-100">Critical Alerts</h3>
                  <AlertTriangle className="w-5 h-5 text-red-600 dark:text-red-400" />
                </div>
                <div className="space-y-3">
                  <div className="p-3 bg-red-100 dark:bg-red-900/40 rounded-lg border border-red-200 dark:border-red-800">
                    <p className="font-semibold text-sm text-red-900 dark:text-red-100">Stock Alert</p>
                    <p className="text-red-700 dark:text-red-300 text-xs">Fiber cable: 500m remaining</p>
                  </div>
                  <div className="p-3 bg-red-100 dark:bg-red-900/40 rounded-lg border border-red-200 dark:border-red-800">
                    <p className="font-semibold text-sm text-red-900 dark:text-red-100">Overdue Payment</p>
                    <p className="text-red-700 dark:text-red-300 text-xs">TechCorp: R45,200 (45 days)</p>
                  </div>
                </div>
            ...
            <Card className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm">
              <div className="p-6">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Monthly Performance</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-slate-700">
                    <span className="text-gray-600 dark:text-slate-400 font-medium">Completed Jobs</span>
                    <span className="font-bold text-gray-900 dark:text-white">47</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-slate-700">
                    <span className="text-gray-600 dark:text-slate-400 font-medium">Avg Completion</span>
                    <span className="font-bold text-green-600 dark:text-green-400">94%</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-600 dark:text-slate-400 font-medium">Customer Rating</span>
