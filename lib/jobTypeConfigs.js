    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "survey_scheduled_for",
            label: "Survey Scheduled",
            type: "date",
          },
          {
            name: "installation_scheduled_for",
        ...
        fields: [
          {
            ...
            label: "Status",
            type: "select",
            defaultValue: "awaiting_client_installation_date",
            options: [
              { value: "awaiting_client_installation_date", label: "Awaiting Client Installation Date" },
    ...
    sections: [
      {
        title: "Client Information",
        icon: Building2,
        className: "bg-cyan-50 dark:bg-cyan-900/20 border-cyan-200 dark:border-cyan-700",
        gridCols: "grid-cols-1 md:grid-cols-2",
        fields: [
          {
            name: "client",
