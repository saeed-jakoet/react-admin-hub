...
export const jobTypeConfigs = {
  "drop-cable": {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: Activity,
        className:
          "bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border-amber-200 dark:border-amber-700",
  ...
  "link-build": {
    ...
    sections: [
        ...
        fields: [
          {
            ...
            options: [
              ...
              {
                value: "Completed Asbuild Outstanding",
                label: "Completed Asbuild Outstanding",
              },
              { value: "Cancelled", label: "Cancelled" },
              { value: "On Hold", label: "On Hold" },
              {
                value: "Awaiting Health and Safety",
                label: "Awaiting Health and Safety",
              },
            ],
          },
      ...
      {
        title: "ATP (Acceptance Test Procedure)",
        icon: Calendar,
        fields: [
          {
